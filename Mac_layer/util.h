...
#define DEFAULT_NET_PKT_SIZE         ((int)(  21 * sizeof(u_int8_t)))
#define DEFAULT_APP_PKT_SIZE         ((int)(  21 * sizeof(u_int8_t)))
...
#define ADJACENT_ADDRESS_2           ((u_int8_t)0x02)
...
#define SEA_AREA_A                   ((u_int8_t)0xf0)
#define SEA_AREA_B                   ((u_int8_t)0xf1)
#define SEA_AREA_C                   ((u_int8_t)0xf2)
...
#define CFRM_PROC_TIME               ((int)20)
#define DATA_PKT_PROC_TIME           ((int)40)
#define TRAN_DELAY_TIME              ((int)10)

// ------------------------- Definition for Error control -------------------------
#define ERROR_TITLE  "MAC_LAYER ERROR"
